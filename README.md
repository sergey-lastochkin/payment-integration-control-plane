...
![Итог локального прогона сценариев сбоев](failure_lab/runs/local-2026-08-11-01/report/failure-summary.svg)
...
Новый прогон содержит 18 сценариев. Он подтверждает один `operation_id` для повтора, сохранение более сильного статуса, durable replay protection после reopen и один успешный claim из двух независимых процессов. Результаты по каждому сценарию лежат в [summary.json](failure_lab/runs/local-2026-08-11-01/summary.json); прошлый run сохранён для истории.
...
Таблица составлена из [summary.json](failure_lab/runs/local-2026-08-11-01/summary.json). Это не данные УПП, n8n или банка.
